...
doc = """
Voting_practice_treatment_2
"""


class C(BaseConstants):
    NAME_IN_URL = 'Voting_practice_treatment_2'
    PLAYERS_PER_GROUP = 5
    NUM_ROUNDS = 5
...
page_sequence = [StartRoundWaitPage, Welcome, General_Instructions, Main_Instructions, Practice, ResultsWaitPage0, question_answering, ResultsWaitPage1, Info_and_decision, ResultsWaitPage2, network_and_voting, ResultsWaitPage3, ResultsWaitPage4, ResultsWaitPage5, Results]
