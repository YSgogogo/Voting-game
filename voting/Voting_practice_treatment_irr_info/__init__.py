...
class Player(BasePlayer):
    ...
    def get_decision_options(self):
        if self.p_count == 0:
            ...
            if self.irrinfo == 'o':
                return C.MAJORITY_O_4
            else:
                return C.MINORITY_P_1
        elif self.p_count == 2:
            if self.irrinfo == 'o':
                return C.MAJORITY_O_3
            else:
                return C.MINORITY_P_2
        elif self.p_count == 3:
            if self.irrinfo == 'o':
                return C.MINORITY_O_2
            else:
                return C.MAJORITY_P_3
        elif self.p_count == 4:
            if self.irrinfo == 'o':
                return C.MINORITY_O_1
            else:
                return C.MAJORITY_P_4
        else:
            return C.ALL_P
